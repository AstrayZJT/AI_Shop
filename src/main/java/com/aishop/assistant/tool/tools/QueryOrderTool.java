...
public class QueryOrderTool implements AssistantTool {
    ...
    private static final ToolSpecification SPECIFICATION = ToolSpecification.builder()
            ...
            .parameters(JsonObjectSchema.builder()
                    .addStringProperty("orderNo", "要查询的订单号")
                    .required("orderNo")
    ...
    public ToolExecutionOutcome execute(ToolContext context, PreparedToolCall call) {
        ...
        return new ToolExecutionOutcome(Map.of("order", view), "订单查询成功");
    }
